...
if [ "$TRAVIS_REPO_SLUG" == "locomotivemtl/charcoal-search" ] && [ "$TRAVIS_PULL_REQUEST" == "false" ] && [ "$TRAVIS_PHP_VERSION" == "5.6" ]; then
    ...
    echo -e ">>> http://locomotivemtl.github.io/charcoal-search/apigen/$TRAVIS_BRANCH/ \n"
fi
